...
class Command(BaseCommand):
    # UPDATED HELP TEXT
    help = 'Generates dummy online order data from 2023-01-01 up to the end of September 2025.'
    ...
    def create_dummy_medicines(self):
        ...
        # Use helper function to get all category choices
        ...
        MEDICINE_PRICES = {
            ...
            'Aspirin': 2.50, 'Diatabs': 8.50, 'Kremil-S': 21.25, 'Ascof': 8.75,
            'Solmux': 12.50, 'Tuseran Forte': 11.25, 'Robitussin': 12.00, 'Mucosolvan': 20.75,
            'Advil': 9.00, 'Voltaren': 42.50, 'Plavix': 75.75, 'Lipitor': 35.25,
            'Norvasc': 21.75, 'Losartan': 17.00, 'Cozaar': 23.25, 'Zestril': 28.25,
            'Gabapentin': 42.25, 'Augmentin': 67.25, 'Medicol': 7.25, 'Novaluzid': 16.00,
            'Maalox': 12.25, 'Motilium': 42.75, 'Buscopan': 34.50, 'Lincocin': 38.00,
            'Clindamycin': 38.50, 'Azithromycin': 67.20, 'Bactrim': 33.00, 'Zithromax': 151.43,
            'Celebrex': 55.50, 'Arcoxia': 72.75, 'Dolfenal': 20.75, 'Ponstan': 40.50,
            'Virlix': 37.00
        }
    ...
    def create_online_sales(self):
        # 🌟 UPDATED MESSAGE
        self.stdout.write(self.style.NOTICE('Creating a large set of dummy online sales records from 2023-01-01 up to the end of September 2025...'))
        ...
        initial_inventory_items = list(Inventory.objects.all()) # Convert to list for random.choice
        ...
        # Slight increase in base orders for online vs. in-store (50-70 vs 40-60)
        ...
        for day_offset in range(total_days + 1):
            ...
            for _ in range(num_orders_per_day):
                with transaction.atomic():
                    ...
                    # Date fulfilled is always after the date created/pickup schedule
                    ...
                    total_before = 0
                    total_after = 0
                    items_added = set() # Ensure no duplicate item in the same order
                    ...
                    for _ in range(num_items_in_order):
                        ...
                        min_qty = 1 
                        max_qty = min(8, item_weight) + random.randint(0, 2) 
                    ...
                    if items_added:
                        ...
                        order.delete() # Delete order if no items were added
    ...
    def handle(self, *args, **options):
        # 🌟 UPDATED MESSAGE
        self.stdout.write(self.style.SUCCESS('Starting dummy data generation for online 2023-2025 (~2.75 years) up to September 30, 2025...'))
        ...
        self.stdout.write(self.style.SUCCESS('Online data generation for ~2.75 years completed successfully!'))