...
class _MyOrdersPageState extends State<MyOrdersPage> with SingleTickerProviderStateMixin {
  ...
  Future<List<dynamic>> _fetchCustomerOrders() async {
    final url = 'http://bluewhiteph.pythonanywhere.com/api/customer/${widget.customerId}/online-orders/';
  ...
  Future<void> _cancelOrder(int orderId) async {
    final url = 'http://bluewhiteph.pythonanywhere.com/api/customer/cancel-online-order/$orderId/';
