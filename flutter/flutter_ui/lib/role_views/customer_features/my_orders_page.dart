...
class _MyOrdersPageState extends State<MyOrdersPage> with SingleTickerProviderStateMixin {
  ...
  Future<List<dynamic>> _fetchCustomerOrders() async {
    final url = 'http://192.168.1.12:8000/api/customer/${widget.customerId}/online-orders/';
  ...
  Future<void> _cancelOrder(int orderId) async {
    final url = 'http://192.168.1.12:8000/api/customer/cancel-online-order/$orderId/';
