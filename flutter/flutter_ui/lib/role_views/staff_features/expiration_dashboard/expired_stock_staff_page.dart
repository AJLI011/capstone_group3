...
class ExpiredStockStaffPage extends StatefulWidget {
  const ExpiredStockStaffPage({Key? key}) : super(key: key);

  @override
  State<ExpiredStockStaffPage> createState() => _ExpiredStockStaffPageState();
}

class _ExpiredStockStaffPageState extends State<ExpiredStockStaffPage> {
  ...
  Future<void> _fetchAllExpiredStocks() async {
    ...
    final String url = 'http://bluewhiteph.pythonanywhere.com/api/medicines/expired/';
