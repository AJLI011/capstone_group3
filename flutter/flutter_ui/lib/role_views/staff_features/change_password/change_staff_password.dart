...
class ChangeStaffPasswordPage extends StatefulWidget {
  ...
  const ChangeStaffPasswordPage({super.key, required this.staffId});

  @override
  State<ChangeStaffPasswordPage> createState() => _ChangeStaffPasswordPageState();
}
...
class _ChangeStaffPasswordPageState extends State<ChangeStaffPasswordPage> {
  ...
  Future<void> _changePassword() async {
    ...
    final url = Uri.parse('http://jallybee.pythonanywhere.com/api/staff/${widget.staffId}/change-password/');
