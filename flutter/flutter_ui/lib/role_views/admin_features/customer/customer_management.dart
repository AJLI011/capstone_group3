...
class _CustomerManagementScreenState extends State<CustomerManagementScreen> {
  ...
  Future<void> fetchCustomers() async {
    ...
    try {
      final res = await http.get(Uri.parse('http://jallybee.pythonanywhere.com/api/customers/'));
  ...
  Future<void> deleteCustomer(int id) async {
    final res = await http.delete(Uri.parse('http://jallybee.pythonanywhere.com/api/customers/$id/'));
