...
void fetchExpiredMedicines() async {
  final response = await http.get(Uri.parse('https://aaron.pythonanywhere.com/api/medicines/expired/'));
...
Future<void> markAsReturned(int inventoryId, int index) async {
  ...
  final String deleteUrl = 'https://aaron.pythonanywhere.com/api/medicines/delete/$inventoryId/';
  ...
  try {
    ...
    final String deleteUrl =
        'https://aaron.pythonanywhere.com/api/medicines/delete/$inventoryId/?staff_id=$staffId';
