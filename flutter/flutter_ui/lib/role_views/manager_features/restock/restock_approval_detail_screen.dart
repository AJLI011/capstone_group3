...
class _RestockApprovalDetailScreenState extends State<RestockApprovalDetailScreen> {
  ...
  Future<void> _fetchPrDetails() async {
    final String apiUrl = '10.0.2.2:8000/api/restock/purchase-request/${widget.prId}/';
  ...
  void _submitApproval() async {
    ...
    final String apiUrl = '10.0.2.2:8000/api/restock/purchase-request/${widget.prId}/approve/'; 
