...
class InventoryApiService {
  static const String inventoryUrl = 'http://jallybee.pythonanywhere.com/api/inventory/';
  ...
  static Future<void> syncTotalQuantities() async {
    try {
      final response = await http.get(
        Uri.parse('http://jallybee.pythonanywhere.com/api/inventory/total-quantities'),
      );
      if (response.statusCode == 200) {
