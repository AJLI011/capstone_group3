...
class _PurchaseRequestPageState extends State<PurchaseRequestPage> {
    ...
    Future<void> _fetchPurchaseRequests() async {
        ...
        const String apiUrl = 'http://192.168.1.11:8000/api/purchase-request/';
        try {
    ...
    Future<void> _generateAndSavePdf() async {
        ...
        try {
            ...
            final lowStockResponse = await http.get(Uri.parse('http://192.168.1.11:8000/api/medicines/low-stock/'));
