...
class _AddMedicineScreenState extends State<AddMedicineScreen> {
  ...
  Future<bool> _checkBarcodeExistence(String barcode) async {
    ...
    final url = Uri.parse('http://192.168.0.100:8000/api/medicines/check_barcode/$barcode/');
    try {
  ...
  Future<void> _fetchSuppliers() async {
    // IMPORTANT: Replace with your computer's actual local IP address!
    final url = Uri.parse('http://192.168.0.100:8000/api/suppliers/');
    try {
      final response = await http.get(url);
      if (response.statusCode == 200) {
        setState(() {
  ...
  Future<void> _addMedicine() async {
    ...
    // IMPORTANT: Replace with your computer's actual local IP address!
    final url = Uri.parse('http://192.168.0.100:8000/api/medicines/');
