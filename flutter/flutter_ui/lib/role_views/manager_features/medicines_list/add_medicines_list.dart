...
class _AddMedicineScreenState extends State<AddMedicineScreen> {
  ...
  // --- API URLS ---
  final String _medicineCreateUrl = 'http://bluewhiteph.pythonanywhere.com/api/medicine/create/';
  final String _linkPrItemBaseUrl = 'http://bluewhiteph.pythonanywhere.com/api/restock/purchase-request/link-new-medicine/';
