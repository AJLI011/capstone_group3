...
class _AddMedicineScreenState extends State<AddMedicineScreen> {
  ...
  // --- API URLS ---
  final String _medicineCreateUrl = 'http://192.168.1.5:8000/api/medicine/create/';
  final String _linkPrItemBaseUrl = 'http://192.168.1.5:8000/api/restock/purchase-request/link-new-medicine/';
  ...
  Future<bool> _checkBarcodeExistence(String barcode) async {
    ...
    final url = Uri.parse('http://192.168.1.5:8000/api/medicines/check_barcode/$barcode/');
    try {
  ...
  Future<void> _fetchSuppliers() async {
    ...
    // IMPORTANT: Replace with your computer's actual local IP address!
    final url = Uri.parse('http://192.168.1.5:8000/api/suppliers/');
    try {
      final response = await http.get(url);
      if (response.statusCode == 200) {
        setState(() {
