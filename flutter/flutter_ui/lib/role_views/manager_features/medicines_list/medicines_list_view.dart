...
class _MedicineListViewState extends State<MedicineListView> {
  ...
  Future<void> _fetchMedicines() async {
    ...
    final uri = Uri.parse('http://192.168.0.100:8000/api/medicines/?page=$_page&page_size=$_pageSize');
  ...
  void _deleteMedicine(int? id) async {
    ...
    final uri = Uri.parse('http://192.168.0.100:8000/api/medicines/$id/?staff_id=$staffId');
