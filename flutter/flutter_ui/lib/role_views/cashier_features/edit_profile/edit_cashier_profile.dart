...
class _EditCashierProfilePageState extends State<EditCashierProfilePage> {
  ...
  void fetchCashierData() async {
    final response = await http.get(
      Uri.parse('https://aaron.pythonanywhere.com/api/staff/${widget.staffId}/profile/'),
  ...
  Future<void> saveProfile() async {
    final url = Uri.parse('https://aaron.pythonanywhere.com/api/staff/${widget.staffId}/update-profile/');
