...
class EditCashierProfilePage extends StatefulWidget {
  ...
  const EditCashierProfilePage({super.key, required this.staffId});

  @override
  _EditCashierProfilePageState createState() => _EditCashierProfilePageState();
}
...
class _EditCashierProfilePageState extends State<EditCashierProfilePage> {
  ...
  void fetchCashierData() async {
    final response = await http.get(
      Uri.parse('http://jallybee.pythonanywhere.com/api/staff/${widget.staffId}/profile/'),
  ...
  Future<void> saveProfile() async {
    final url = Uri.parse('http://jallybee.pythonanywhere.com/api/staff/${widget.staffId}/update-profile/');
